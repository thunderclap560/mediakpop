		...
		<div class="table-responsive">
			<table class="table table-striped">
				<tr class="table-header">
					...
					<th><a href="javascript:void(0)" id="delete-all">Delete</a></th>
					@foreach($media as $item)
					<tr>
						<td><input class="checkbox1" type="checkbox" name="check[]" value="{{$item->id}}"/></td>
...
$(document).ready(function() {
    ...
    $("#delete-all").click(function(){
    	window.location.href = "{{ URL::to('media/all')}}"+"?id="+allVals;
    });   
});
$(document).ready(function(){
